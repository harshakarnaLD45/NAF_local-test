              ...
              <TableHead>
                <TableRow sx={{ backgroundColor: '#2a2a2a' }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_table_col_data_category')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    fontWeight: 600,
                    ...
                    {t('privacypolicy.privacy_table_col_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    fontWeight: 600,
                    ...
                    {t('privacypolicy.privacy_table_col_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    fontWeight: 600,
                    ...
                    {t('privacypolicy.privacy_table_col_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    fontWeight: 600,
                    ...
                    {t('privacypolicy.privacy_table_col_legal_basis')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    fontWeight: 600,
                    ...
                    {t('privacypolicy.privacy_table_col_retention')}
                  </TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_account_identifier')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_account_identifier_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_account_identifier_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_account_identifier_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_account_identifier_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_account_identifier_retention')}
                  </TableCell>
                </TableRow>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_contact_information')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_contact_information_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_contact_information_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_contact_information_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_contact_information_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_contact_information_retention')}
                  </TableCell>
                </TableRow>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_authentication_data')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_authentication_data_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_authentication_data_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_authentication_data_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_authentication_data_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_authentication_data_retention')}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
              ...
              <TableBody>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_payment_references')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_payment_references_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_payment_references_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_payment_references_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_payment_references_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_payment_references_retention')}
                  </TableCell>
                </TableRow>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_wallet_balance')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_wallet_balance_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_wallet_balance_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_wallet_balance_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_wallet_balance_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_wallet_balance_retention')}
                  </TableCell>
                </TableRow>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_reservation_records')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_reservation_records_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_reservation_records_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_reservation_records_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_reservation_records_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_reservation_records_retention')}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
              ...
              <TableBody>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_device_data')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_device_data_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_device_data_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_device_data_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_device_data_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_device_data_retention')}
                  </TableCell>
                </TableRow>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_usage_logs')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_usage_logs_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_usage_logs_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_usage_logs_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_usage_logs_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_usage_logs_retention')}
                  </TableCell>
                </TableRow>
                ...
                <TableRow sx={{ '&:hover': { backgroundColor: '#333' } }}>
                  <TableCell sx={{
                    ...
                    {t('privacypolicy.privacy_row_login_history')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_login_history_examples')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_login_history_platforms')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_login_history_purpose')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_login_history_legal')}
                  </TableCell>
                  <TableCell sx={{
                    color: '#fcfcfc',
                    border: '1px solid #444'
                  }}>
                    {t('privacypolicy.privacy_row_login_history_retention')}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
