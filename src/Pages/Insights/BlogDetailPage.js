      ...
      <Box sx={{ position: "relative" }} className="section-container blogdetailedcontainer">
        <Stack direction="row" justifyContent="space-between" >
          <Button
            ...
            sx={{ color: "#FCFCFC",  padding:'0px',textTransform: "none", "&:hover": {
          ...
          <Button
            onClick={() => navigate("/blog/choosing-vending-machine-guide")}
        ...
        >
          How UI/UX Design Can Boost Your Vending Machine Sales
        </Typography>
        <Box
          sx={{
            display: "flex",
