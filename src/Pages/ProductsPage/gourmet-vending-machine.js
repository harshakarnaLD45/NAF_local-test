...
<Box sx={{ mt: 18, mb: 8, px: { xs: 2, md: 0 } }}>
  <Box sx={{ mb: { xs: 3, md: 4 }, textAlign: 'center' }}>
    ...
    <Typography className="bodyRegularText3" sx={{ color: '#c2c2c4', mb: 1, textAlign: 'center' }}>
      Flexible payment options to fit your business needs. All prices exclude VAT.
    </Typography>
  </Box>
  ...
  <Grid container spacing={{ xs: 8,sm:8, md: 3 }} justifyContent="center">
    ...
    <Grid item xs={12} sm={12} md={4}lg={4}>
      ...
      <Paper sx={{
        ...
        <List dense sx={{ p: 0, mt: 4, flexGrow: 1 }}>
          <ListItem sx={{ p: 0, mb: 1 }}>
            <ListItemIcon sx={{ minWidth: 30 }}>
              <TickIcon />
            </ListItemIcon>
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.purchase.benefit1')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.purchase.benefit2')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.purchase.benefit3')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.purchase.benefit4')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 4 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.purchase.benefit5')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
      ...
      <Paper sx={{
        ...
        <List dense sx={{ p: 0, mt: 4, flexGrow: 1 }}>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.leasing.benefit1')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.leasing.benefit2')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.leasing.benefit3')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.leasing.benefit4')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.leasing.benefit5')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.leasing.benefit6')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
    ...
    <Grid item xs={12} sm={12} md={4}lg={4}>
      <Paper sx={{
        ...
        <List dense sx={{ p: 0, mt: 4, flexGrow: 1 }}>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.hirePurchase.benefit1')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.hirePurchase.benefit2')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.hirePurchase.benefit3')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 1 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.hirePurchase.benefit4')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
          <ListItem sx={{ p: 0, mb: 4 }}>
            ...
            <ListItemText 
              primary={t('products.gourmetMachine.pricing.hirePurchase.benefit5')} 
              primaryTypographyProps={{ sx: { color: '#c2c2c4' } }} 
              className="bodyRegularText3" 
            />
          </ListItem>
      ...
      {/* Seasonal, CTA & FAQ */}
    <Container maxWidth="md" sx={{ mt: { xs: 12, md: 18 } }}>
  <Typography
    sx={{
      textAlign: 'center',
      color: '#FCFCFC',
