...
import { SoftwareExpertiseIcon1, SoftwareExpertiseIcon2, SoftwareExpertiseIcon3, SoftwareExpertiseIcon4, SoftwareExpertiseIcon5 } from '../../Componenets/CustomIcons';
    ...
    const expertiseData = [
        {
            ...
            icon: SoftwareExpertiseIcon1, // Replace with an actual icon if available
        },
        {
